...
// Cette activite affiche les infos de l'utilisateur (Age, Poids, Taille, Objectif)
// L'utilisateur peut modifier ces informations et les enregistrer sur notre BD
